...
const MS_Telegram_Token = "6696493183:AAGapXdnhFG2U6ln9sVt-bUcRIDzgjJJzws"; // Сюда вписать свой токен от бота из @BotFather
const MS_Telegram_Chat_ID = "-1001822512803"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта
